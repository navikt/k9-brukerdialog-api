...
fun JSONObject.somOmsorgsdagerKomplettMelding(): no.nav.k9brukerdialogapi.ytelse.omsorgsdagermelding.domene.OmsorgsdagerKomplettMelding = objectMapper.readValue(this.toString())
